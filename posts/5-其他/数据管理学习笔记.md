...
1. single source of truth：所有的状态都放在一个store中

<br/>
<img src='https://github.com/jiangxia/FE-Knowledge/raw/master/images/103.jpg' width='800'>
<br/>

2. 可预测性：state + action = new state。状态非常稳定，要产生一个新状态，肯定是由一个action触发的，最终产生一个新的state，而不是在原来state上修改。
3. 纯函数更新store （reducer）
